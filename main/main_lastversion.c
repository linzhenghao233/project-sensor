...
//         //               ↓↓↓  这里的逻辑已被修正  ↓↓↓
//         // =============================================================
//         // 1. 直接调用 DHT11() 函数，让它更新全局变量 wendu 和 shidu
//         DHT11();
...
//         // 计算土壤湿度
//         current_data.soil_moisture = 100.0f * (SOIL_DRY_VALUE - soil_adc_raw) / (SOIL_DRY_VALUE - SOIL_WET_VALUE);
//         if (current_data.soil_moisture > 100.0f) current_data.soil_moisture = 100.0f;
//         if (current_data.soil_moisture < 0.0f) current_data.soil_moisture = 0.0f;
